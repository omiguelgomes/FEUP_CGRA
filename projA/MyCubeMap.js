...
class MyCubeMap extends CGFobject {
    constructor(scene) 
    {
        ...
        this.scene.frontMaterial.loadTexture('wall.jpg');
        ...
        this.scene.backMaterial.loadTexture('wall.jpg');
        ...
        this.scene.upMaterial.loadTexture('sky.jpg');
        ...
        this.scene.downMaterial.loadTexture('floor.jpg');
        ...
        this.scene.rightMaterial.loadTexture('wallMirror.jpg');
        ...
        this.scene.leftMaterial.loadTexture('wallMirror.jpg');
