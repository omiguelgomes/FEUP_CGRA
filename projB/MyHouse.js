...
class MyHouse extends CGFobject {
    constructor(scene) 
    {
        ...
        this.scene.pilarTex.loadTexture('images/marble_tex.png');
        ...
        this.scene.roofTex.loadTexture('images/roof.jpg');
        ...
        this.scene.wallMaterial.loadTexture('images/house_wall_tex.jpg');
